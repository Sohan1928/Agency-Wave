          ...
          <div className=" login-back-color w-full items-center max-w-sm shrink-0 shadow-2xl">
            <form onSubmit={handleLogin} className="card-body">
              <div className="mt-3 mx-auto text-white">
                ...
                <p className="mt-1 text-center">Send, spend and save smarter</p>
              </div>
              <div className="form-control mt-7 mb-4">
                <input
                  type="email"
                  placeholder="Email"
                  className="py-3 px-2 rounded-lg bg-[#3a262c] text-white"
                  name="email"
                  required
                />
              </div>
              ...
              <div className="form-control mt-6 ">
                <button className="btnStyle py-2 w-full rounded-lg bg-[#2bbeb9] hover:bg-transparent hover:border">
                  Login
                </button>
                <Link to="/signUp">
