    ...
    <div className="px-4 max-w-6xl mx-auto">
      <div className="lg:flex py-10 px-4 justify-around items-center">
        <div data-aos="fade-right" data-aos-duration="2200" className="">
          ...
          <Link to="/contacts">
            <button className="px-6 py-3 text-white font-bold rounded-full border border-[#48adac] transition duration-300 delay-150 hover:bg-[#56b4c1]">
              Contact Us
            </button>
          </Link>
        </div>
        <div data-aos="fade-left" data-aos-duration="2200">
          ...
          <div className="collapse collapse-arrow">
            ...
            <div className="collapse-title text-xl font-medium text-[#ffd60a] ">
